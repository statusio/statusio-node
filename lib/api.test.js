...
var API_ID, API_KEY, RIGHT_COMPONENTS, RIGHT_CONTAINERS, RIGHT_STATUSPAGE_ID, StatusIOApi, WRONG_COMPONENTS, WRONG_CONTAINERS, WRONG_STATUSPAGE_ID, assert, expect;

assert = require('chai').assert;

expect = require('chai').expect;

StatusIOApi = require('./api.coffee').StatusIOApi;
...
describe('incidents', (function(_this) {
  return function() {
    ...
    return it('incidents.delete right incident_id', function(done) {
